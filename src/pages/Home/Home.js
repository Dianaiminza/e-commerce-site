            ...
            >
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    Shoes to fit your every occassion.
                  </p>
                  <Button variant="success" className="my-2">
                    Shop now
                  </Button>
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    Shoes to satisfy your customer needs.
                  </p>
                  <Button variant="success" className="my-2">
                    Shop now
                  </Button>
      ...
      <Row className="my-5">
        <Col xs={6} className="mx-auto">
          <blockquote className="blockquote text-center">
            <p className="mb-0">
              Kicks Kenya offers the most affordable,good quality,and long lasting shoes to suit your evey occassion.
            </p>
